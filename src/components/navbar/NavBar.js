        ...
        <nav id="Navbar" className="navbar navbar-expand-lg fixed-top navbar-dark">
            ...
            <div className="nb-links navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul className="navbar-nav mr-auto">
                    ...
                    <Field link="New In" text1="bras" text2="Panties" text3="linguerie">
                    </Field>
                    <Field link="Collection" text1="SpringTime" text2="SummerTops" text3="LaceAge">
                    </Field>
                    <Field link="Sale" text1="2019 Temp" text2="2018 Temp" text3="Past years...">
                    </Field>
